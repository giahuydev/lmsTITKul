...
@Component
public class HocSinhExcelParser implements ExcelRowParser<ParsedStudentExcelRow> {

    @Override
    public ParsedStudentExcelRow parse(Row row, int rowNum) {
    ...
    private void validate(ParsedStudentExcelRow row) {
