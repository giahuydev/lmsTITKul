...
public interface NotificationRepository extends JpaRepository<Notification, Long> {
    ...
    @Query("SELECT n FROM Notification n WHERE (n.classRoom.lopHocId = :classRoomId OR n.classRoom IS NULL) AND n.audience IN :audiences ORDER BY n.postedAt DESC")
    ...
    List<Notification> findBySender_NguoiDungIdOrderByPostedAtDesc(Long senderId);
}
