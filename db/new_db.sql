...
CREATE TABLE bai_nop (
    ...
    dang_bai_id_uk  INT UNSIGNED GENERATED ALWAYS AS (COALESCE(dang_bai_id, 0)) STORED
                    COMMENT 'Cột phụ cho UNIQUE KEY: MySQL coi NULL luôn khác NULL nên dang_bai_id thô không chặn được nộp trùng ở bài TU_DO/TU_LUAN (dang_bai_id NULL) — quy ước 0 = "không có dạng bài", an toàn vì dang_bai_id thật luôn AUTO_INCREMENT từ 1',
    ...
    UNIQUE KEY uk_baitap_hs_dangbai_lan (bai_tap_id, hoc_sinh_id, dang_bai_id_uk, so_lan_lam),
